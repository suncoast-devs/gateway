STATUS = {0 => "active", 1 => "pending", 10 => "won", 11 => "lost", 12 => "cancelled"}

STAGES = {"student" => "enrolled", "alumni" => "enrolled", "prospecting" => "applied", "qualified" => "applied"}
...
namespace :nutshell do
  ...
  task sync: :environment do
    ...
    leads.each.with_index do |stub, i|
      ...
      notes = (contact["notes"] + lead["notes"]).map { |n| [n["user"] && n["user"]["emails"].first || nil, n["noteMarkup"]] }
